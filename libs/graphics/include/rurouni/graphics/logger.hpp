#ifndef RR_LIBS_GRAPHICS_LOGGER_H
#define RR_LIBS_GRAPHICS_LOGGER_H
...
static std::string logger_name = "graphics";
...
void require(T&& assertion,
    ...
    if (!assertion) {
        spdlog::get(logger_name)
            ->critical("{}:{} -> {} *** assertion failed", location.file_name(),
...
#endif  // !RR_LIBS_GRAPHICS_LOGGER_H
