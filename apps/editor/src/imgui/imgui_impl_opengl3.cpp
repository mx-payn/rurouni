...
//  ImGuiPlatformIO interface. 2023-11-08: OpenGL: Update GL3W based
//  imgui_impl_opengl3_loader.h to load "libGL.so" instead of "libGL.so.1",
//  accomodating for NetBSD systems having only "libGL.so.3" available. (#6983)
//  2023-10-05: OpenGL: Rename symbols in our internal loader so that LTO
//  compilation with another copy of gl3w is possible. (#6875, #6668, #4445)
