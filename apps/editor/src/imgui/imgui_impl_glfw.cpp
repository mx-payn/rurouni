...
//  ImGuiPlatformIO interface. 2023-10-05: Inputs: Added support for extra
//  ImGuiKey values: F13 to F24 function keys. 2023-07-18: Inputs: Revert
...
#ifdef _WIN32
    bd->PrevWndProc = (WNDPROC)::GetWindowLongPtr(
